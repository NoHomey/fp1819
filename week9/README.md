...
9. (Анди) Дефинирайте функция `count pred a b`, която проверява за колко измежду числата в целочисления интервал `[a, b]` е верен предикатът `pred`

10. Дефинирайте функция `sumEven a b`, която намира сумата на всички четни числа в интервала `[a, b]`

11. Дефинирайте предикат `prime number`, който проверява дали дадено число е просто

12. Дефинирайте предикат `coprime number1 number2`, която проверява дали `number` и `number2` са взаимнопрости (т.е. най-големият им общ делител е 1)

13. Хипотезата на Голдбах е, че
...
14. Функцията на Ойлер се дефинира като
