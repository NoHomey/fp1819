...
5. Дефинирайте функция `reverse number`, която "обръща" дадено число

6. Дефинирайте функция `sumDivisors number`, която намира сумата от делителите да дадено число

7. Дефинирайте предикат `palindrome number`, който проверява дали дадено чило е палиндром

8. Дефинирайте функция `applyMultiple number f arg`, която прилага функцията f n пъти пример:
...
11. (Анди) Дефинирайте функция `count pred a b`, която проверява за колко измежду числата в целочисления интервал `[a, b]` е верен предикатът `pred`

12. Дефинирайте функция `sumEven a b`, която намира сумата на всички четни числа в интервала `[a, b]`

13. Дефинирайте предикат `prime number`, който проверява дали дадено число е просто

14. Дефинирайте предикат `coprime number1 number2`, която проверява дали `number` и `number2` са взаимнопрости (т.е. най-големият им общ делител е 1)

15. Хипотезата на Голдбах е, че
...
16. Функцията на Ойлер се дефинира като

  > φ(n) = броя на естествените числа, ненадминаващи n и взаимно прости с n

  Дефинирайте функция `euler number`, която намира прилага функцията на Ойлер над `number`
